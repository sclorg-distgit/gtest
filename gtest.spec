%{?scl:%scl_package gtest}
%{!?scl:%global pkg_name %{name}}

Summary:        Google C++ testing framework
Name:           %{?scl_prefix}gtest
Version:        1.6.0
Release:        3%{?dist}
License:        BSD
...
%check
LD_LIBRARY_PATH=$RPM_BUILD_DIR/%{pkg_name}-%{version}/build make test
...
%changelog
* Sun May 05 2013 Honza Horak <hhorak@redhat.com> - 1.6.0-3
